        ...
        $(".slider3").animate({ opacity: 0 }, 400),
          setTimeout(function () {
            t.hasClass("slider3--next")
              ? a - 1 > i && a - 1 > s && a - 1 > o
                ? (l
                    .removeClass("slider3--item-left")
                    .next()
                    .addClass("slider3--item-left"),
                  c
                    .removeClass("slider3--item-center")
                    .next()
                    .addClass("slider3--item-center"),
                  h
                    .removeClass("slider3--item-right")
                    .next()
                    .addClass("slider3--item-right"))
                : i === a - 1
                ? (u
                    .removeClass("slider3--item-left")
                    .first()
